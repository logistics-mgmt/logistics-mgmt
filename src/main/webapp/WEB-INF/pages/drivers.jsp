...
$( ".delete-driver-button" ).button().on( "click", function() {
        ...
        bootbox.confirm("Usunąć kierowcę "+driverFirstName+" "+driverLastName+"("+driverPesel+")?" , function(result){
          if(result == true)
  ...
  <c:forEach var="driver" items="${drivers}">
          <tr>
              ...
              <td>${driver.address.street} ${driver.address.houseNumber}, ${driver.address.town}, ${driver.address.country}</td>
                ...
                <td><a class="btn btn-primary edit-driver-button" href="/drivers/edit/${driver.id}">Edytuj</a></td>
                <td><button class="btn btn-danger delete-driver-button" id="delete-button-${driver.id}">Usuń</button></td>
          </tr>
  </c:forEach>
  </table>
</body>
