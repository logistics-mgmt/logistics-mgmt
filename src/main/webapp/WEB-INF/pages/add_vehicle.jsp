...
<!-- Static navbar -->
  ...
  <form name="add_vehicle_form" id="add_vehicle_form" data-toggle="validator" onsubmit="return addVehicle();">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="engine"  path="engine" data-minlength="11" name="engine" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="horsepower" name="horsepower" path="horsepower" />
      </div>
      <div class="form-group">
        <label for="productionDate">Data produkcji:</label>
        <input type="text" class="form-control" id="productionDate" name="productionDate" path="productionDate" />
      </div>
      <div class="checkbox">
