...
<body>
	...
	<form name="add_vehicle_form" id="add_vehicle_form"
		...
		onsubmit="return addVehicle();">
		<div class="form-group">
			<label for="brand" class="col-sm-2 control-label">Marka:</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" name="brand" path="brand"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="model" path="model"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="number" value="${vehicle.maxPayload}"
					class="form-control" id="maxPayload" path="maxPayload"
					name="maxPayload" required="true" />
			</div>
		</div>
		<div class="form-group">
			<label for="engine" class="col-sm-2 control-label">Silnik:</label>
			<div class="col-sm-8">
				<input type="number" class="form-control" id="engine" path="engine"
					data-minlength="11" name="engine" required="true" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="vin" name="vin"
					path="vin" minlength="17" maxlength="17"
					data-error="VIN musi miec dokładnie 17 znaków." required="true" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="number" class="form-control" id="horsepower"
					name="horsepower" path="horsepower" required="true" />
			</div>
		</div>
		<div class="form-group">
			<label for="productionDate" class="col-sm-2 control-label">Data
				produkcji:</label>
			<div class="col-sm-8">
				<input type="date" class="form-control" id="productionDate"
					name="productionDate" path="productionDate" required="true" />
			</div>
		</div>
