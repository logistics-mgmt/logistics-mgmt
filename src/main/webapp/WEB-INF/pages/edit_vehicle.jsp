...
<!-- Static navbar -->
  ...
  <form name="edit_vehicle_form" id="edit_vehicle_form" data-toggle="validator" onsubmit="return editVehicle();">
      ...
      <div class="form-group">
        ...
        <input type="number" value="${vehicle.engine}" class="form-control" id="engine"  path="engine" name="engine" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="number" value="${vehicle.mileage}" class="form-control" id="mileage" name="mileage" path="mileage" />
      </div>
      <div class="form-group">
        <label for="horsepower">KM:</label>
        <input type="number" value="${vehicle.horsepower}" class="form-control" id="horsepower" name="horsepower" path="horsepower" />
      </div>
      <div class="form-group">
        <label for="productionDate">Data produkcji:</label>
        <input type="date" value="${vehicle.productionDate}" class="form-control" id="productionDate" name="productionDate" path="productionDate" />
      </div>
      <div class="checkbox">
