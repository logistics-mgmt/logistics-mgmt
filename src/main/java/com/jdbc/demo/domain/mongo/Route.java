...
public class Route {
	...
	// TODO: implement method for static Route creation for given transportId
	// and vehicleId
	...
	public String getWaypointsString() {
		...
		if (builder.length() == 0)
			...
			return builder.toString(); // return string without the trailing
										// pipe
	}

	public List<RouteWaypoint> getWaypointsList() {
		// Perhaps some more elegant implementation could be added in th
		// future...
