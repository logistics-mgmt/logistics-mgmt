...
public class ScheduleEvent {
    /**
    Represents Event_Object used by FullCalendar - JS event calendar(http://fullcalendar.io).
    Refer to Event_Object documentation(http://fullcalendar.io/docs/event_data/Event_Object/)
     for description of properties.
     */
    private long id;
