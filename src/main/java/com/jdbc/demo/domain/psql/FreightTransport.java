...
public class FreightTransport {
	...
	@ManyToMany
	@JoinTable(name = "FreightTransportVehicles", joinColumns = {
			@JoinColumn(name = "id_FreightTransport") }, inverseJoinColumns = { @JoinColumn(name = "id_Vehicle") })
	private List<Vehicle> vehicles = new ArrayList<>();

	@ManyToMany
	@JoinTable(name = "FreightTransportDrivers", joinColumns = {
	...
	public boolean equals(Object o) {
		...
		if (distance != that.distance)
			return false;
		if (!loadAddress.equals(that.loadAddress))
			return false;
		if (!unloadAddress.equals(that.unloadAddress))
			return false;
		if (!value.equals(that.value))
			return false;
		if (loadDate != null ? !loadDate.equals(that.loadDate) : that.loadDate != null)
			return false;
		if (unloadDate != null ? !unloadDate.equals(that.unloadDate) : that.unloadDate != null)
			return false;
		...
		if (!client.equals(that.client))
			return false;
		if (!(vehicles.size() == that.vehicles.size() && that.vehicles.containsAll(vehicles)))
			return false;
	...
	public String toString() {
		return "FreightTransport{" + "id=" + id + ", loadAddress=" + loadAddress + ", unloadAddress=" + unloadAddress
				+ ", distance=" + distance + ", value=" + value + ", loadDate=" + loadDate + ", unloadDate="
				+ unloadDate + ", paymentDate=" + paymentDate + ", finished=" + finished + ", notes='" + notes + '\''
				+ ", client=" + client + '}';
	}
