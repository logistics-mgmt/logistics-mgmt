...
public class Driver {
	...
	@JoinTable(name = "FreightTransportDrivers", joinColumns = {
			@JoinColumn(name = "id_Driver") }, inverseJoinColumns = { @JoinColumn(name = "id_FreightTransport") })
	...
	public String toString() {
		return "Driver{" + "id=" + id + ", address=" + address + ", firstName='" + firstName + '\'' + ", lastName='"
				+ lastName + '\'' + ", PESEL='" + PESEL + '\'' + ", salary=" + salary + ", salaryBonus=" + salaryBonus
