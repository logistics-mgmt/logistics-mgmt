...
public class AddressRestController {
     ...
     * @param address JSON document describing new Address
     * @return JSON document describing added Address (with appropriate ID field)
     */
     ...
     * @param address JSON document describing Address to update
