...
public class VehicleRestController {
	...
	/**
	 * Allows binding of dates provided by FullCalendar or other clients which
	 ...
	 * 
	 * @param vehicle
	 *            JSON document describing new Vehicle
	 * @return JSON document describing added Vehicle (with appropriate ID
	 *         field)
	 */
	 ...
	 * 
	 * @param vehicle
	 *            JSON document describing Vehicle to update
