...
public class FreightManagerTest {
	...
	public void setUp() throws Exception {
		...
		testFreightTransports.add(TestModelsFactory.createTestFreightTransport1(testClients.get(0), testDrivers,
				testVehicles, testAddresses.get(0), testAddresses.get(1)));

	}

	@Test
	public void testGetAll() throws Exception {
		testFreightTransports.add(TestModelsFactory.createTestFreightTransport1(testClients.get(1), testDrivers,
				testVehicles, testAddresses.get(1), testAddresses.get(0)));
