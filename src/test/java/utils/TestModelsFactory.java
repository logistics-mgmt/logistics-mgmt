...
public abstract class TestModelsFactory {
	...
	public static User createTestUser1(Set<UserRole> userProfile) {
		User User1 = new User();
		User1.setLogin("admin1");
		User1.setPassword("admin1");
		User1.setFirstName("Jan");;
		User1.setLastName("Kowalski");;
		User1.setUserRoles(userProfile);
		return User1;
	}
	
	public static User createTestUser2(Set<UserRole> userProfile) {
		User User2 = new User();
		User2.setLogin("admin2");
		User2.setPassword("admin2");
		User2.setFirstName("Andrzej");;
		User2.setLastName("Nowak");;
		User2.setUserRoles(userProfile);
		return User2;
	}
}
